                        ...
                        {data?.channels.map((channel, index) => {
                            return (
                                <button
                                    ...
                                    key={channel.slug}
                                    className={`${selectedChannel === index ? "cursor-pointer font-PeydaBold" : ""
            ...
            <div className="h-fit flex w-full items-end">
                ...
                <div className="h-[140px] md:h-[233px] p-3 md:p-0 flex flex-col md:block justify-between items-center   w-full relative ">
                    ...
                    <div className="flex w-full justify-between">
                        <div className="w-full md:w-[72%] h-0.5 mt-5 bg-white  relative z-10"></div>
                        <div className="hidden md:block w-1/4 h-0.5 mt-5 bg-white  relative z-10"></div>
                    </div>
                    <div className="flex items-start  md:py-[29px]   justify-between w-full">
                        <div className="flex w-full md:w-[72%] flex-col  md:pl-[65px]">
                            <h6 className="text-xl sm:text-2xl md:text-[44px] text-headline-base font-bold md:leading-[100%]">
                                {data?.channels[selectedChannel]?.name}
                            </h6>
                            <p className="text-neutral-light text-sm sm:text-xl">
